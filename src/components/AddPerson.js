...
class AddPerson extends Component {
	...
	onAddPress(){
		const { first_name, last_name, email, phone, company, project, notes } = this.props; 

		this.props.createNewContact({ first_name, last_name, email, phone, company, project, notes });
...
const mapStateToProps = state => {
	...
	const { first_name, last_name, email, phone, company, project, notes } = state; 

	return { first_name, last_name, email, phone, company, project, notes };
};
